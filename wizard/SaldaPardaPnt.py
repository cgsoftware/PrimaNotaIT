...
class salda_partite(osv.osv_memory):
    ...
    _columns = {
                ...
                'par_scadenze': fields.one2many('salda.partite.righe', 'name', 'Scadenze da Saldare'),
                }
                    ...
                    for scadenza in testapar.par_scadenze:
                        if scadenza.da_saldare<>0:
                            scad_riga=   {
                                                ...
                                                'da_saldare':scadenza.da_saldare,
                                                'flg_salda':False,
                                                'saldatt':0.0,
...
class salda_partite_righe(osv.osv_memory):
    ...
    _columns = {
                    'name': fields.many2one('salda.partite', 'Testata Wizard Saldaconto',ondelete='cascade', required=True, select=True),
        ...
        if scadenza_id:
            ...
            if flg_salda:
              ...
              if importo_resi<>0:
                ...
                result = self.calcola_residuo(cr, uid, importo_resi, importo_oper, da_saldare, saldatt, flg_salda, scadenza_id, context)
 ...
 # VANNO ANCORA GESTITI GLI EVENTUALI ABBUONI ATTIVI O PASSIVI   
    def calcola_residuo(self,cr,uid,importo_resi,importo_oper,da_saldare,saldatt,flg_salda,scadenza_id,context=None):
        res = {}
        if not context:
            context={}        
        if scadenza_id:
            ...
            if 'F' in causale.tipo_documento and flg_salda:
                ...
                if importo_resi> da_saldare: 
                    ...
                    calcolato = True
                    da_saldare -= attuale
            if 'F' in causale.tipo_documento and not flg_salda:
